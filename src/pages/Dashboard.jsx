    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (userDoc.exists()) {
          ...
          // Get saved products
          const savedIds = userDoc.data().savedProducts || [];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">{userData?.name || 'User'}</h1>
          ...
          <div>
            ...
            {savedProducts.length > 0 ? (
              ...
              <div className="bg-white rounded-lg shadow-md p-12 text-center">
                ...
                <p className="text-slate-600">You haven't saved any products yet. Start exploring!</p>
              </div>
            )}
          </div>
        )}
          ...
          <div>
            ...
            {inquiries.length > 0 ? (
                ...
                {inquiries.map(inquiry => (
                  <div key={inquiry.id} className="bg-white rounded-lg shadow-md p-6">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <h3 className="text-lg font-bold text-slate-900">{inquiry.productName}</h3>
              ...
              <div className="bg-white rounded-lg shadow-md p-12 text-center">
                ...
                <p className="text-slate-600">You haven't sent any inquiries. Explore products and get in touch!</p>
              </div>
            )}
          </div>
        )}
